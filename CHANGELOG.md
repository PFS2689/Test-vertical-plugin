...
- **Transform:** Fit to Vertical Canvas / Fill Vertical Canvas use explicit uniform scale + center on the Vertical Shorts canvas (`min`/`max` of canvas/source ratios). New cameras default to Fit. Edit Transform popup includes Fit / Fill / Center / Reset buttons.
